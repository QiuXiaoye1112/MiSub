<template>
  <div class="not-found-container font-sans text-gray-100 dark:text-gray-100">
    ...
    <div class="relative z-10 glass-panel border border-white/10 misub-radius-lg p-12 max-w-lg w-[90%] text-center shadow-2xl backdrop-blur-xl animate-fade-in-up">
      ...
      <router-link v-if="false" to="/" class="inline-flex items-center justify-center px-8 py-3 text-base font-semibold text-white bg-primary-600 hover:bg-primary-500 rounded-full transition-all duration-300 shadow-lg shadow-primary-500/30 hover:-translate-y-1 hover:shadow-primary-500/50">
